...
class ProduitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produit" do
    assert_difference("Produit.count") do
      post produits_url, params: { produit: { amount: @produit.amount, stripe_price_id: @produit.stripe_price_id, stripe_product_id: @produit.stripe_product_id } }
    end
  ...
  test "should update produit" do
    patch produit_url(@produit), params: { produit: { amount: @produit.amount, stripe_price_id: @produit.stripe_price_id, stripe_product_id: @produit.stripe_product_id } }
